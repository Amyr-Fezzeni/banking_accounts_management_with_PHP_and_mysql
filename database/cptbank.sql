...
--
-- Hôte : 127.0.0.1
-- Généré le :  sam. 17 avr. 2021 à 01:52
...
('Amyr', 'Fezzeni', '12121212', 'homme', '1993-05-15', 'tunis', 'tunis', 'el nasr 2', 'mail@live.fr', '20334455', 'manar 2');
...
CREATE TABLE `images` (
  `id` int(4) NOT NULL,
  `id_client` varchar(8) COLLATE utf8mb4_unicode_ci NOT NULL,
...
--
ALTER TABLE `cheque`
  MODIFY `numch` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT pour la table `compte`
--
ALTER TABLE `compte`
  MODIFY `numcp` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `operation`
  MODIFY `numop` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
--
-- AUTO_INCREMENT pour la table `reclamation`
--
ALTER TABLE `reclamation`
  MODIFY `numrec` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
