...
<body>
    ...
    <div class="content">
        ...
        <form class="form-style-1" method="POST" action="gestion_des_operations.php">
    ...
    if(isset($_POST['chbtn']))
    {
        ...
        $sql ="SELECT * from operation where $s ='$ch' $date ORDER BY 1 DESC";
...

{
  ...
  $sql ="SELECT * from operation $date ORDER BY 1 DESC;";
