...
if (isset($_POST["ajouter"]) ) 
     ...
     { 
        ...
        if (isset ($res['prenom'])){
            ...
            $sql="INSERT INTO employes (prenom, nom, id, mail, tel, sexe, date_n, pays, ville, adresse,agence) 
            VALUES ('$prenom' ,'$nom','$id','$mail','$tel','$sexe','$date_n','$pays','$ville','$adresse','$agence')";     
            if (mysqli_query($conn, $sql)) {

                $msg= "Employé ajouter avec succée";
        ...
        function controle_information()
{
    ...
    <div class="content">
        ...
        <fieldset>
            ...
            <form class="form-style-1" method="POST" action="ajout_employe.php" onsubmit="return controle_information() ">
                <table border="0">
                    <tr>
                    ...
                    <tr>
                        <td></td>
                        <td align="center"><input type="text" name="agence" placeholder="Agence" required  style="min-width: 254px;"></td>
                    </tr>
