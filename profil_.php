...
if (isset($_POST['valider'])) {
    ...
    $sql_update = "SELECT type FROM connexion where id=".$id." ";
    $result_update = $conn->query($sql_update);
    $res_update = $result_update->fetch_assoc();

    $type=$res_update['type'];

    $query_update= "UPDATE $type SET prenom='".$_POST['prenom']."', nom='".$_POST['nom']."', tel='".$_POST['tel']."', mail='".$_POST['mail']."', sexe='".$_POST['sexe']."', date_n='".$_POST['date_n']."', pays='".$_POST['pays']."', ville='".$_POST['ville']."', adresse='".$_POST['adresse']."'  where id='$id'";
