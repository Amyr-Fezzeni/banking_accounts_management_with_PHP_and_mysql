...
if (isset($_POST['valider'])) {
    ...
    $query_update= "UPDATE employes SET prenom='".$_POST['prenom']."', nom='".$_POST['nom']."', tel='".$_POST['tel']."', mail='".$_POST['mail']."', sexe='".$_POST['sexe']."', date_n='".$_POST['date_n']."', pays='".$_POST['pays']."', ville='".$_POST['ville']."',agence = '".$_POST['agence']."', adresse='".$_POST['adresse']."'  where id='$id'";
...
<body>
    ...
    <div class="content">
        ...
        <fieldset><legend align=center>Modifier Employé</legend>

            <form class="form-style-1" name="profileform" method="POST" action="modifier_employe.php"
             enctype="multipart/form-data" >



           
                <table border="0"  style="padding-left: 0px; min-width: 100%;" >
                    <tr>
                        <td style="min-width: 150px"> Prenom : </td>
                        ...
                        <td align="right"  style="width: 300px; text-align: right"><input type="text" name="chercher" style="text-align: right; margin-left: 50px" value="<?php echo $id; ?>"></td>
                    ...
                    <tr>
                        <td> Agence : </td>
                         <td>
                            <input type="text" disabled name="agence" id="agence" value="<?php echo $res["agence"] ; ?>"  style="min-width: 254px;">
                        </td>
                    </tr>
            ...
            <form class="form-style-1" method="POST" action="modifier_client.php" 
