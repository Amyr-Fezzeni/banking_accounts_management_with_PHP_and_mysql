...
if (isset($_POST['chercherclient'])) {
    $id=$_POST['chercherclient'];
}else 
{$id="";}
...
if (isset($_POST['chclientbtn'])) {
    if ($_POST['chercherclient'] == ""){
        $id="0";
    }else{
    $id=$_POST['chercherclient'];
}
...
if (isset($_POST['valider'])) {
    ...
    $query_update= "UPDATE client SET prenom='".$_POST['prenom']."', nom='".$_POST['nom']."', tel='".$_POST['tel']."', mail='".$_POST['mail']."', sexe='".$_POST['sexe']."', date_n='".$_POST['date_n']."', pays='".$_POST['pays']."', ville='".$_POST['ville']."', adresse='".$_POST['adresse']."'  where id='$id'";
...
<body>
    ...
    <div class="content">
        ...
        <fieldset> <legend align=center>Modifier Client</legend>

            <form class="form-style-1" name="profileform" method="POST" action="modifier_client.php"
             enctype="multipart/form-data" >



           
                <table border="0"  style="padding-left: 0px; min-width: 100px;" >
                    <tr>
                        ...
                        <td align="right"  style="width: 300px; "><input type="text" name="chercherclient" style="text-align: right;  margin-left: 50px" value="<?php echo $id; ?>"></td>
                    ...
                    <tr>
                        ...
                        <td align="right"><input type="submit" name="chclientbtn" value="chercher"></td>
                    </tr>
